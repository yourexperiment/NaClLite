...
void __fastcall FrameStageNotifyThink(PVOID CHLClient, void *_this, ClientFrameStage_t Stage) 
{
	...
	{
//removed resolver due to anti-pasta
//you can just add your own shitty resolver or some cs:go resolver pasta, potassium's aimbot isn't really meant for hvh but if u want, go for it.
	}
